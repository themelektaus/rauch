...
Write-Host "`n=== Microsoft Logout Script ===" -ForegroundColor Cyan
Write-Host "Zielbenutzer: $UserName" -ForegroundColor Yellow

# 1. Microsoft-Prozesse beenden
Write-Host "`n[1/6] Beende Microsoft-Prozesse..." -ForegroundColor Green
$processes = @(
...
Write-Host "`n[2/6] Entferne Microsoft-Credentials aus Credential Manager..." -ForegroundColor Green
$credTargets = @(
    "MicrosoftOffice*",
    "Microsoft.AAD*",
    "Microsoft.Office*",
...
Write-Host "`n[3/6] Lösche Token-Cache und Identity-Daten..." -ForegroundColor Green
...
Write-Host "`n[4/6] Lösche Teams-Cache und Anmeldedaten..." -ForegroundColor Green
$teamsPaths = @(
...
# 5. OneDrive abmelden
Write-Host "`n[5/6] Melde OneDrive ab..." -ForegroundColor Green
...
Write-Host "`n[6/6] Bereinige Registry-Einträge..." -ForegroundColor Green
$regPaths = @(
...
Write-Host "`n[Bonus] WAM-Reset wird durchgeführt..." -ForegroundColor Magenta
